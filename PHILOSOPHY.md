# GROASIS TECH - MASTER DESIGN SYSTEM (V2.1 - TECHNICAL BLUEPRINT)
...
* **Base Void:** `#000000` (Usado para el Hero y los márgenes exteriores).
...
* **Prohibición de Renders Fotorrealistas:** Toda representación de las patentes debe ser mediante *Isometría Analítica de Línea Clara* (estética de Blueprint de Manufactura). Se mostrarán vectores puros que insinúan planos técnicos listos para entrar a la línea de ensamblaje.
